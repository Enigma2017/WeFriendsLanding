...
btn.addEventListener('submit', (e) => {
 ...
 if(name === '' || email === ''){
  fullCheck.innerHTML = `<span>You should fill all fields!</span>`;  
 }else{
  const form = document.querySelector('#form');
  form.remove();
  fullCheck.innerHTML = `<p>Thank you for your subcribtion!</p>
                        <span>We will send you all the information as soon as we launch</span>`
 }
